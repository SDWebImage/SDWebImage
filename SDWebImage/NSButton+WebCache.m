...
- (NSURL *)sd_currentAlternateImageURL {
    return [self sd_imageLoadStateForKey:SDAlternateImageOperationKey].url;
}

- (NSProgress *)sd_currentAlternateImageProgress {
    return [self sd_imageLoadStateForKey:SDAlternateImageOperationKey].progress;
}
...
- (void)setsd_currentAlternateImageProgress:(NSProgress *)sd_currentAlternateImageProgress {
    ...
    SDWebImageStateContainer *stateContainer = [self sd_imageLoadStateForKey:SDAlternateImageOperationKey];
    if (!stateContainer) {
        stateContainer = [SDWebImageStateContainer new];
    }
    stateContainer.progress = sd_currentAlternateImageProgress;
    [self sd_setImageLoadState:stateContainer forKey:SDAlternateImageOperationKey];
}

- (SDWebImageTransition *)sd_currentAlternateImageTransition {
    return [self sd_imageLoadStateForKey:SDAlternateImageOperationKey].transition;
}
...
- (void)setsd_currentAlternateImageTransition:(SDWebImageTransition *)sd_currentAlternateImageTransition {
    ...
    stateContainer.transition = sd_currentAlternateImageTransition;
    [self sd_setImageLoadState:stateContainer forKey:SDAlternateImageOperationKey];
}
