...
// All the stored operations are weak, so it will be deallocated after image loading finished. If you need to store operations, use your own class to keep a strong reference for them.
