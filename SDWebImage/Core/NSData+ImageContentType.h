 ...
 */
+ (SDImageFormat)sd_imageFormatForImageData:(nullable NSData *)data NS_SWIFT_NAME(sd_imageFormat(from:));
 ...
 */
+ (SDImageFormat)sd_imageFormatFromUTType:(nonnull CFStringRef)uttype NS_SWIFT_NAME(sd_imageFormat(from:));
